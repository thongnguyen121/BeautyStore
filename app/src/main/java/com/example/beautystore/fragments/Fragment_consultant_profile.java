...
public class Fragment_consultant_profile extends Fragment {
    ImageView imageView;
    ...
    private void setControl(View view) {
        imageView = view.findViewById(R.id.imgAnhTTV);
        tvNameShipper = view.findViewById(R.id.tvNameTTV);
        tvMailShipper = view.findViewById(R.id.tvEmailTTV);
        btnEditProfile = view.findViewById(R.id.btnEditProfileTTV);
        btnChangePassword = view.findViewById(R.id.btnEditProfileChangePassword);
        btnLogout = view.findViewById(R.id.btnLogoutTTV);
    }
}